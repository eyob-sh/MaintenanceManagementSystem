# Generated by Django 4.2.19 on 2025-02-19 11:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_of_measurement', models.CharField(help_text='Enter the unit of measurement (e.g., Liters, grams, kilograms).', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('maintenance_for', models.CharField(choices=[('Scheduled_Maintenance', 'Scheduled_Maintenance'), ('Work Order', 'Work Order')], default='Scheduled_Maintenance', help_text='Select the type of maintenance.', max_length=30)),
        ...
        migrations.AddField(
            model_name='maintenancerecord',
            name='work_order',
            field=models.ForeignKey(blank=True, help_text='Select a work order if applicable.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='maintenance.workorder'),
        ),
        migrations.CreateModel(
